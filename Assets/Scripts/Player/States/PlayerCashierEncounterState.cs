...
[Serializable]
public class PlayerCashierEncounterState : PlayerState
{
    ...
    private IEnumerator EncounterCoroutine()
    {
        ...
        yield return StartCoroutine(DialogueSystem.Instance.RunDialogueCoroutine("dread_where_are_you_going"));
        ...
        yield return StartCoroutine(DialogueSystem.Instance.RunDialogueCoroutine("dread_put_down_on_counter"));
        ...
        yield return StartCoroutine(DialogueSystem.Instance.RunDialogueCoroutine("dread_you_need_to_pay"));
